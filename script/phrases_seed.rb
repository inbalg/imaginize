...
Phrase.create!(text: "The godfather", category: "movies")
...
Phrase.create!(text: "American History X", category: "movies")
Phrase.create!(text: "American Pie X", category: "movies")
